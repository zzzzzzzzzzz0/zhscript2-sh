...
public:
	char typ_ = 0, typ2_ = 0;
	bool new_window_ = false, is_app_paintable_ = false, is_popup_ = false;
	bool to_ = true, to2_ = true, has_button_ = true, can_close_ = true;
	char pos_ = 'c';
	...
	bool first_no_ = false, down_ = false, no_focus_ = false,
			append_ = false, insert0_ = false, left_ = false,
			only_switch_ = false, no_switch_ = false, use_open_ = true,
			is_set_typ_ = false,
			is_set_to_ = false,
